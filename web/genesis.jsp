...
<body >
  ...
  <div id="genesis" class="bgimg-1">
  <div class="container">
    <div class="row">
      <div class="col-xs-12 mainEvent">
        GENESIS - Biotechnology Events
      </div>
      <!--first event-->
      <div class="col-xs-12 subEvent">
        ...
        <div class="col-sm-9 ">
          <div class="col-sm-12 title">
            <u>Forensic Science Investigation</u>
          </div>
        ...
        <div class="col-sm-12 content">
          Forensic science is the application of science to criminal and civil laws, mainly on the criminal side during criminal investigation, as governed by the legal standards of admissible evidence and criminal procedure. Forensic scientists collect, preserve, and analyze scientific evidence  during the course of an investigation.<br>
          <ul type="square">
          <li>This is a group event.</li>
          <li>Participant Team has to collect clues and evidence as much as possible.</li>
          <li>Crime Scene will be created with blood samples, skin residues and other biological contents.</li>
          <br>
          
          <jsp:include page="registerevent.jsp">
             <jsp:param name="eid" value="1" />
             <jsp:param name="page" value="genesis.jsp" />
          </jsp:include>
      ...
      <div class="col-xs-12 subEvent">
        ...
        <div class="col-sm-12 content">
          ...
          Biotechnology processes and terms can be the plot of a comic story which can create a scientific humor and a well understanding of matter.<br>
          <ul type="square">
          <li>This is a solo event.</li>
          <li>Participant have to create a comic story in accordance to explain a biotech process.</li>
          <br>

          <jsp:include page="registerevent.jsp">
             <jsp:param name="eid" value="2" />
             <jsp:param name="page" value="genesis.jsp" />
          </jsp:include>
     ...
     <div class="col-xs-12 subEvent">
        ...
        <div class="col-sm-9 ">
          <div class="col-sm-12 title">
            <u>Paper and Poster Presentation</u>
          </div>
          <div class="col-xs-12 visible-xs hidden-sm hidden-md hidden-lg hidden-xl  info">
            <span class="location"><i class="fa fa-calendar " aria-hidden="true"></i></span>  11-12 April<br>
            <span class="location"><i class="fa fa-map-marker " aria-hidden="true"></i></span>  &nbsp U.I.E.T KUK<br><br>
        ...
        <div class="col-sm-12 content">
          A poster presentation is the presentation of research information by an individual or representatives of research teams at a congress or conference with an academic or professional focus. A research fellow must know about the paper publishing and an appropriate choice of subject and matter in his/her research paper.<br>
          <ul type="square">
          <li>Participants have to bring their own printed flex / poster of size 8x4 feets.</li>
          <li>Judging will be based on presentation and paper presented to judges.</li>
          <br>
          
          <jsp:include page="registerevent.jsp">
             <jsp:param name="eid" value="3" />
             <jsp:param name="page" value="genesis.jsp" />
          </jsp:include> 
