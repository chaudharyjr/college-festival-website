...
$(document).scroll(function () {
        ...
        if ( y > 0){
          /* fixed left ryt top bottomcolor 626D71*/
            ...
            $('#fixedright .rotate-right').fadeIn("fast").css({"background-color":"#ffffff","z-index":"1000","color":"#141617"});                        
            $('#fixedright .rotate-right i').fadeIn("fast").css({"background-color":"#ffffff","z-index":"1000","color":"#141617"});
