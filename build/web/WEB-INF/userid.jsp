...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/animate.csas" />
  ...
  <div id="notify" class="bgimg-1" >
    <div class="container">
      <div class="row" style="height:100vh">
        <div class="col-xs-12" >
         <h2> User ID : <%=st.getUserid()%><br>
           Passowrd : <%=st.getPassword()%><br>
        </h2>
          <h4>Please remember the user ID and password for logging onto the website.
          <br>
          Thankyou for your time!</h4>
             <form action="toprofile" method="post">
            <input value="Profile" type="submit" class="registerButton">
