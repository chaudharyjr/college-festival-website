...
<body >
  ...
  <div id="technical" class="bgimg-1" >
    <div class="container">
      <div class="row" style="">
        <div class="col-xs-12">
          <div class="mainEvent col-xs-12">Technical Events</div>
          <div class="col-xs-12 subEvent">
            <div class="col-sm-3 col-xs-12">
              <a href="innovatia.jsp"><img class="img img-responsive img-thumbnail" src="images/cultural.jpg"></a>
            </div>
            <div class="col-sm-9 col-xs-12 content">
              <a href="innnovatia.jsp"><u>Innovatia</u></a>
               is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event.
              <br><br>
              <a class="registerButton" href="innovatia.jsp">Go to Innovatia</a>
            </div>
          </div>
          <div class="col-sm-12  col-xs-12 subEvent">
            <div class="col-sm-3 col-xs-12">
              <a href="genesis.jsp"><img class="img img-responsive img-thumbnail" src="images/cultural.jpg"></a>
            </div>
            <div class="col-sm-9 col-xs-12 content">
              <a href="genesis.jsp"><b><u>Genesis</u></b></a>
               is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event.
              <br><br>
              <a class="registerButton" href="genesis.jsp">Go to Genesis</a>
            </div>
          </div>
          <div class="col-xs-12 subEvent">
            <div class="col-sm-3 col-xs-12">
              <a href="takneek.jsp"><img class="img img-responsive img-thumbnail" src="images/cultural.jpg"></a>
            </div>
            <div class="col-sm-9 col-xs-12 content">
              <a href="takneek.jsp"><u>Takneek</u></a>
               is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event.
              <br><br>
              <a class="registerButton" href="takneek.jsp">Go to Dakshta</a>
            </div>
          </div>
          <div class="col-xs-12 subEvent">
            <div class="col-sm-3 col-xs-12">
              <a href="dakshta.jsp"><img class="img img-responsive img-thumbnail" src="images/cultural.jpg"></a>
            </div>
            <div class="col-sm-9 col-xs-12 content">
              <a href="dakshta.jsp"><u>Dakshta</u></a>
               is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event. Genesis is the biotechnological Event.
              <br><br>
              <a class="registerButton" href="dakshta.jsp">Go to Takneek</a>
            </div>
          </div>
        </div>
      </div>
